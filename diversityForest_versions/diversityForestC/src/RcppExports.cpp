...
#include "../inst/include/diversityForestC.h"
#include <RcppEigen.h>
#include <Rcpp.h>
...
RcppExport SEXP _diversityForestC_numSmaller(SEXP valuesSEXP, SEXP referenceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_diversityForestC_divforCpp", (DL_FUNC) &_diversityForestC_divforCpp, 51},
    {"_diversityForestC_numSmaller", (DL_FUNC) &_diversityForestC_numSmaller, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_diversityForestC(DllInfo *dll) {
