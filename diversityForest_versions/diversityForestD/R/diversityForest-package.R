...
##' in the help pages of 'ranger', version 0.11.0, because 'diversityForestD' is based on the latter version of 'ranger'. 
...
##'   }
##'
##' @name diversityForestD-package
##' @aliases diversityForestD
NULL