...
##' in the help pages of 'ranger', version 0.11.0, because 'diversityForestB' is based on the latter version of 'ranger'. 
...
##'   }
##'
##' @name diversityForestB-package
##' @aliases diversityForestB
NULL