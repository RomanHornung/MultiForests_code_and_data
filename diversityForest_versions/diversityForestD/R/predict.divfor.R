...
##' efficient C++ implementation. More precisely, 'diversityForestD' was written by modifying
##' the code of 'ranger', version 0.11.0. Therefore, details on further functionalities
##' of the code that are not presented in the help pages of 'diversityForestD' are found
