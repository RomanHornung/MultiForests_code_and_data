...
##' 'ranger', where some parts of the documentation may not apply to (the current version of) the 'diversityForestA' package.
##'
##' Details on further functionalities of the code that are not presented in the help pages of 'diversityForestA' are found
##' in the help pages of 'ranger', version 0.11.0, because 'diversityForestA' is based on the latter version of 'ranger'. 
...
##'   }
##'
##' @name diversityForestA-package
##' @aliases diversityForestA
NULL