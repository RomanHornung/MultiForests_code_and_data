...
#include "../inst/include/diversityForestA.h"
#include <RcppEigen.h>
#include <Rcpp.h>
...
RcppExport SEXP _diversityForestA_numSmaller(SEXP valuesSEXP, SEXP referenceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_diversityForestA_divforCpp", (DL_FUNC) &_diversityForestA_divforCpp, 51},
    {"_diversityForestA_numSmaller", (DL_FUNC) &_diversityForestA_numSmaller, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_diversityForestA(DllInfo *dll) {
