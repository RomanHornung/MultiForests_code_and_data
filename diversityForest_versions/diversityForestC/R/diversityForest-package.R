...
##' in the help pages of 'ranger', version 0.11.0, because 'diversityForestC' is based on the latter version of 'ranger'. 
...
##'   }
##'
##' @name diversityForestC-package
##' @aliases diversityForestC
NULL