...
##' efficient C++ implementation. More precisely, 'diversityForestB' was written by modifying
##' the code of 'ranger', version 0.11.0. Therefore, details on further functionalities
##' of the code that are not presented in the help pages of 'diversityForestB' are found
