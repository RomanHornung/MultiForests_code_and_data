...
#include "../inst/include/diversityForestD.h"
#include <RcppEigen.h>
#include <Rcpp.h>
...
RcppExport SEXP _diversityForestD_numSmaller(SEXP valuesSEXP, SEXP referenceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_diversityForestD_divforCpp", (DL_FUNC) &_diversityForestD_divforCpp, 51},
    {"_diversityForestD_numSmaller", (DL_FUNC) &_diversityForestD_numSmaller, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_diversityForestD(DllInfo *dll) {
